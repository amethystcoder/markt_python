...
class BuyerProductRequest(MethodView):
    ...
    def get(self,buyer_id):
        ...
        return [parse_requests(request=request,buyer=Buyer(request.buyer_id),user_details=User(request.buyer_id)) for request in BuyerRequest.get_requests_through_buyer_id(buyer_id=buyer_id)]
...
class SellerProductRequest(MethodView):
    ...
    def get(self,seller_id):
        ...
        return [parse_requests(request=request,buyer=Buyer(request.buyer_id),user_details=User(request.buyer_id)) for request in BuyerRequest.get_requests_using_category(seller_category)]
...
class ProductRequestFromCategory(MethodView):
    ...
    def get(self,name):
      ...
      return [parse_requests(request=request,buyer=Buyer(request.buyer_id),user_details=User(request.buyer_id)) for request in BuyerRequest.get_requests_using_category(name)]
